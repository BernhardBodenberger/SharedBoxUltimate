...
{
	public void edit(String aa,String b) throws IOException{
        BufferedReader obj = new BufferedReader(new FileReader(aa));
        String s;
           ...
           j1.addActionListener(new ActionListener() {
       		public void actionPerformed(ActionEvent T) {
       			try{	
       				   String dummy = "";
       				   try {
       				   	BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(aa)));
       				   	String[] array;
       				   	String line;
       				...
       				String txt_path = aa;
       				BufferedReader s = new BufferedReader(new FileReader(aa));
